...
const useCustomLogin = () => {
    ...
    //useRecoilState() 적용
    const [loginState, setLoginState] = useAtom(signinState)
    const resetState = useResetAtom(signinState) //로그아웃 처리
    const resetCartState = useResetAtom(cartState) //장바구니 비우기
